      ...
      <footer className="relative z-10 border-t border-slate-800/50 bg-[#0D0A1C]/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm mb-4 md:mb-0">&copy; 2025 HACKNOVA. All rights reserved.</p>
            <div className="flex space-x-6">
              <a href="#" className="text-slate-400 hover:text-pink-400 transition-colors"><Icons.Twitter /></a>
              <a href="#" className="text-slate-400 hover:text-pink-400 transition-colors"><Icons.LinkedIn /></a>
