import StacsLogo from '../assets/STACS.svg';





// NOTE: The import for a local SVG file has been removed because the environment
// cannot resolve local file paths. The logo is now loaded via a URL.
...
export default function Footer() {
    return (
      <footer className="relative z-10 border-t border-slate-800/50 bg-[#100C23]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 text-white">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            {/* Column 1: About & Logo */}
            <div>
              <h3 className="text-lg font-bold text-white mb-2 tracking-wider">HACKNOVA</h3>
              <div className="flex justify-center md:justify-start mb-2">
                 {/* FIX: Using a standard <img> tag with a URL.
                   Replace the 'src' value with the public URL to your own logo file.
                 */}
                 <img 
                   src={StacsLogo} 
                   alt="STACS Logo" 
            ...
            <div>
              ...
              <div className="flex justify-center md:justify-start space-x-6">
                ...
                <a href="https://www.instagram.com/stacsnssce" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-pink-400 transition-colors"><Icons.Instagram /></a>
                <a href="https://github.com/Stacs-nssce" className="text-slate-400 hover:text-pink-400 transition-colors"><Icons.Github /></a>
              </div>
            </div>
          </div>
